...
| ---- | ---- |
| **Recommended Stack** | [Web TS framework + WeChat / Douyin if needed — scope, team expertise, platform targets] |
...
- [ ] Fill in STUDIO.md technology stack based on Web/MiniGame choice (`/setup-web`, platform skills)
